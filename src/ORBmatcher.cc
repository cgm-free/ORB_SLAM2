...
//    cout << "uint16_t的字节数:" << sizeof(uint16_t) << endl;// uint8_t的字节数:2字节
//    cout << "uint32_t的字节数:" << sizeof(uint32_t) << endl;// uint8_t的字节数:4字节
//    cout << "uint64_t的字节数:" << sizeof(uint64_t) << endl;// uint8_t的字节数:8字节
